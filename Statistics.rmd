...
head(data)
```
Linear regressions were used to test for significant relationships between variables, where fixed variables comprised of treatments, gender, generation, and when possible, were normalized to fly weight. 
